    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.report_list.length > 0) {
          ...
          this.setState({ BloodReports: blood });
                ...
                <Col sm="12" md="6">
                  ...
                  >
                    <div className="card no-shadow rm-border bg-transparent widget-chart text-left">
                      ...
                      <div className="widget-chart-content">
                        <div className="widget-subheading">Blood Pressure</div>
                        <div className="widget-numbers fsize-3">
                          120/80
                        ...
                        <Row>
                          <Col sm="6" md="6" xs="12">
                            <InputGroup className="mb-3">
                              ...
                              <Input value="" placeholder="" type="number" />
                            </InputGroup>
                          </Col>
                          <Col sm="6" md="6" xs="12">
                            <InputGroup className="mb-3">
              ...
              <Card className="mb-3">
                <CardBody>
                  <Col md="12" sm="12" xs="12">
                    <div>
                      <div className="text-focus fsize-2">Patient Details</div>
                    </div>
                    <hr />
                    <Row>
                      <Col sm="7" md="7" xs="12">
                      ...
                      <Col md="5" sm="5" xs="12">
                        <Card className="main-card mb-3 card-radius" style={{}}>
                          <div className="card no-shadow rm-border bg-transparent widget-chart text-left">
                            <div className="widget-chart-actions">
                              <p
                                style={{
                          ...
                          <div className="">&nbsp;Overall status: Normal</div>
                        </Card>
                      </Col>
                    </Row>
                  </Col>
                    ...
                    >
                      ...
                      <ModalBody>
                          ...
                          <Col sm="6" md="6" xs="12">
                            ...
                            <FormGroup>
                              <Input
                                ...
                                value={xreporttype}
                                onChange={(e) =>
                                  this.handleXRayUploadChange("xreporttype", e)
                                }
                              >
                          ...
                          <Col sm="6" md="6" xs="12">
                            ...
                            <InputGroup className="mb-3">
                              ...
                              <InputMask
                                ...
                                value={xreportdate}
                                onChange={(e) =>
                                  this.handleXRayUploadChange("xreportdate", e)
                                }
                              />
                            </InputGroup>
                          </Col>
                        ...
                        <Row>
                          <Col sm="6" md="6" xs="12">
                            <Label for="exampleEmail">
                              <span className="text-danger">*</span> Ref Doctor
                            </Label>
                            <FormGroup>
                              <Input
                                className="mb-2"
                          ...
                          <Col sm="6" md="6" xs="12">
                            ...
                            <InputGroup className="mb-3">
                              ...
                              <InputMask
                                ...
                                value={xreportcode}
                                onChange={(e) =>
                                  this.handleXRayUploadChange("xreportcode", e)
                                }
                              />
                            </InputGroup>
                          </Col>
                        ...
                        <Row>
                          <Col sm="12" md="12" xs="12">
                            ...
                            <TextareaAutosize
                              ...
                              onChange={(e) =>
                                this.handleXRayUploadChange("xreportmessage", e)
                              }
                            />
                          </Col>
                        </Row>
                    ...
                    >
                      ...
                      <ModalBody>
                          ...
                          <Col sm="6" md="6" xs="12">
                            ...
                            <FormGroup>
                              <Input
                                ...
                                type="select"
                                onChange={(e) =>
                                  this.handleReportUploadChange("reporttype", e)
                                }
                                value={reporttype}
                              >
                                <option>Report Type</option>
                          ...
                          <Col sm="6" md="6" xs="12">
                            ...
                            <InputGroup className="mb-3">
                              ...
                              <InputMask
                                ...
                                onChange={(e) =>
                                  this.handleReportUploadChange("reportdate", e)
                                }
                                value={reportdate}
                              />
                            </InputGroup>
                        ...
                        <Row>
                          <Col sm="6" md="6" xs="12">
                            ...
                            <FormGroup>
                              <Input
                                ...
                                type="text"
                                onChange={(e) =>
                                  this.handleReportUploadChange("reportname", e)
                                }
                                value={reportname}
                              />
                            </FormGroup>
                          ...
                          <Col sm="6" md="6" xs="12">
                            <Label for="exampleEmail">
                              <span className="text-danger">*</span> Doctor Ref
                            </Label>
                            <InputGroup className="mb-3">
                              <InputGroupAddon addonType="prepend">
                                <div className="input-group-text">
                              ...
                              <InputMask
                                ...
                                type="text"
                                onChange={(e) =>
                                  this.handleReportUploadChange("refdoctor", e)
                                }
                                value={refdoctor}
                              />
                            </InputGroup>
                    ...
                    >
                      <ModalHeader toggle={this.Recordtoggle}>
                        ...
                        >
                          ...
                          {loading ? <Loader type="ball-clip-rotate" /> : null}
                        </div>
                      </ModalHeader>
                      <ModalBody>
                        <Col sm="12" md="12" xs="12">
                          ...
                          <Input
                            ...
                            value={medicineName}
                            onChange={(e) =>
                              this.handlePrescriptionChange("medicineName", e)
                            }
                          />
                          <div
                            style={{
                        ...
                        <Row>
                          ...
                          <Col sm="6" md="6" xs="12">
                            <Label for="exampleEmail">
                              <span className="text-danger">*</span> Void After
                            </Label>
                            <InputGroup className="mb-3">
                              <InputGroupAddon addonType="prepend">
                                <div className="input-group-text">
                          ...
                          <Col sm="6" md="6" xs="12">
                            ...
                            <FormGroup>
                              <Input
                                ...
                                value={drugRefill}
                                onChange={(e) =>
                                  this.handlePrescriptionChange("drugRefill", e)
                                }
                              >
                ...
                <CardBody className="pt-0">
                  ...
                  >
                    ...
                    <ModalBody>
                      ...
                      <Col sm="12" md="12" xs="12">
                        <Label for="exampleEmail">
                          <span className="text-danger">*</span> Medicine's Name
                        </Label>
                        <Input
                          type="text"
                  ...
                  <div className="btn-actions-pane-right text-capitalize">
                    ...
                    <UncontrolledButtonDropdown>
                      <DropdownToggle
                        ...
                        color="success"
                      >
                        <FontAwesomeIcon icon={faFilePrescription} /> Add Test
                        Reports
                      </DropdownToggle>
                      <DropdownMenu>
                        <Nav vertical>
                            ...
                            >
                              <thead>
                                <tr>
                                  ...
                                  <th className="">Last seen Date</th>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="">
                                    <Button outline size="sm" color="alternate">
                                      <i className="lnr-eye " />
                                    </Button>
                                    &nbsp;
