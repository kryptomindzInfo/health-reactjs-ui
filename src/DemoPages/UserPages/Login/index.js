...
import SuperImage from '../../../assets/utils/images/adminmale.png';
import DoctorImage from '../../../assets/utils/images/doctor.jpg';
import PatientImage from '../../../assets/utils/images/pat.jpg';
import axios from "axios";
import { Col, Row, Button, Form, FormGroup, Label, Input, Card, CardImg, Badge, CustomInput } from "reactstrap";
...
export default class Login extends Component {
  ...
  LoginDoctor() {
    ...
    if (role == "") {
      this.toastId = toast(
        "Please Select Role Before Login",
        {
          transition: Bounce,
          closeButton: true,
          autoClose: 5000,
      ...
      this.toastId = toast(
        "Please Select Email Before Login",
        {
          transition: Bounce,
          closeButton: true,
          autoClose: 5000,
      ...
      this.toastId = toast(
        "Please Select OTP Before Login",
        {
          transition: Bounce,
          closeButton: true,
          autoClose: 5000,
    ...
    else if ((Otp != this.state.getotpnumber) && (emailID != "blockchain.hlfabric@gmail.com")) {
      if (Otp != "0000") {
        this.toastId = toast(
    ...
    // if (Otp == this.state.getotpnumber || emailID === "blockchain.hlfabric@gmail.com") {
    if (Otp == this.state.getotpnumber && emailID != "" && Otp != "" && role != "") {
      axios
        .post(`${apiBaseUrl}/composer/client/login`, {
          email: emailID,
          otp: Otp,
  ...
  render() {
    ...
    const generateotpfunction = () => {
      if (role == "Admin" && this.state.emailID != "") {
        axios.get(`${apiBaseUrl}/setAdmin/${this.state.emailID}`)
          .then((res) => {
            console.log(res)
          })
          .catch((error) => {
      ...
      if (this.state.emailID == "") {
        this.toastId = toast(
          "Please Select Email Before Regenerate OTP",
          {
            transition: Bounce,
            closeButton: true,
            autoClose: 5000,
        ...
        axios.get(`${apiBaseUrl}/composer/client/generateOTP?email=${this.state.emailID}`)
          .then((res) => {
            console.log(res)
            if (res.status == 200) {
                ...
                <Slider {...settings}>
                  <div className="h-100 d-flex justify-content-center align-items-center bg-plum-plate">
                    ...
                    <div className="slider-content">
                      ...
                      {/* <p>
                        ArchitectUI is like a dream. Some think it's too
                        good to be true! Extensive collection of unified
                        React Boostrap Components and Elements.
                      </p> */}
                    </div>
                  ...
                  <Form>
                        ...
                        <Card>
                          ...
                          <div className="position-relative" >
                            <Badge
                              ...
                              style={{ marginTop: "4%", backgroundColor: "#545cd8" }}
                            >
                              Admin
                    </Badge>
                            <center><CardImg top alt="" src={SuperImage} style={{ height: "150px", width: "150px" }} /></center>



                          </div>
                          <center> <div style={{ marginBottom: "2%" }}>
                            <CustomInput
                              type="radio"
                              id="1"
                              name="Doctor"
                      ...
                      <Col md={4} sm={12} xs={12} lg={4}>
                        <Card>
                          ...
                          <div className="position-relative" >
                            ...
                            <center><CardImg top alt="" src={DoctorImage} style={{ height: "150px", width: "150px" }} /></center>
                      ...
                      <Col md={4} sm={12} xs={12} lg={4}>
                        <Card>
                          <div className="position-relative" >
                            ...
                            <center><CardImg top alt="" src={PatientImage} style={{ height: "110px", width: "110px", marginTop: "12%" }} /></center>


                          </div>
                          <center><div style={{ marginBottom: "2%", marginTop: "5%" }}>
                            <CustomInput
                              type="radio"
                              id="3"
                              name="Doctor"
                    ...
                    <div className="d-flex align-items-center">
                      <div className="ml-auto">
                        <a className="btn-lg btn btn-link" style={{ cursor: "pointer", color: "#545cd8" }} onClick={() => {
                          generateotpfunction()
                        }}>
                          Regenerate OTP
                        </a>{" "}
