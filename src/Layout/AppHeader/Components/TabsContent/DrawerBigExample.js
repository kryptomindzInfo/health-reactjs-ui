                                    ...
                                    <div className="widget-content-wrapper">
                                        ...
                                        <div className="widget-content-left">
                                            <div className="widget-heading font-weight-normal">
                                                May 9, 2023—KB5026361 (Builds 19042.2965, 19044.2965, and 19045.2965)
                                            </div>
                                        </div>
                            ...
                            <ListGroupItem className="pt-2 pb-2 pr-2">
                                <div className="widget-content p-0">
                                    <div className="widget-content-wrapper">
                                        ...
                                        <div className="widget-content-left">
                                            <div className="widget-heading font-weight-normal">
                                                April 11, 2023—KB5025221 (Builds 19042.2846, 19044.2846, and 19045.2846)
                                            </div>
                                        </div>
                                        <div className="widget-content-right widget-content-actions">
                                            <Button size="sm" className="btn-icon btn-icon-only" color="link">
                            ...
                            <ListGroupItem className="pt-2 pb-2 pr-2">
                                <div className="widget-content p-0">
                                    <div className="widget-content-wrapper">
                                        ...
                                        <div className="widget-content-left">
                                            <div className="widget-heading font-weight-normal">
                                                March 21, 2023—KB5023773 (Builds 19042.2788, 19044.2788, and 19045.2788) Preview
                                            </div>
                                        </div>
                                        <div className="widget-content-right widget-content-actions">
                                            <Button size="sm" className="btn-icon btn-icon-only" color="link">
                            ...
                            <ListGroupItem className="pt-2 pb-2 pr-2">
                                <div className="widget-content p-0">
                                    <div className="widget-content-wrapper">
                                        ...
                                        <div className="widget-content-left">
                                            <div className="widget-heading font-weight-normal">
                                                March 14, 2023—KB5023696 (Builds 19042.2728, 19044.2728, and 19045.2728)
                                            </div>
                                        </div>
                                        <div className="widget-content-right widget-content-actions">
                                            <Button size="sm" className="btn-icon btn-icon-only" color="link">
                                    ...
                                    <div className="widget-content-wrapper">
                                        ...
                                        <div className="widget-content-left">
                                            <div className="widget-heading">
                                                New 2FA Integration
                                                <div className="badge badge-success ml-2">Accepted</div>
                                            </div>
                                            <div className="widget-subheading">
                                                <i>Sugested by Adam</i>
                                            </div>
                                        </div>
                                        <div className="widget-content-right widget-content-actions">
                                ...
                                <div className="widget-content p-0">
                                    <div className="widget-content-wrapper">
                                        ...
                                        <div className="widget-content-left flex2">
                                            <div className="widget-heading">
                                                Badge on the right task for Doctor
                                            </div>
                                            <div className="widget-subheading">
